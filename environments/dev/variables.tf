...
variable "client_id" {
  description = "Azure Service Principal Client ID (optional when using Azure CLI authentication)"
  type        = string
  sensitive   = true
  default     = ""
}
...
variable "client_secret" {
  description = "Azure Service Principal Client Secret (optional when using Azure CLI authentication)"
  type        = string
  sensitive   = true
  default     = ""
}
...
variable "tenant_id" {
  description = "Azure Tenant ID (optional when using Azure CLI authentication)"
  type        = string
  sensitive   = true
  default     = ""
}
...
# AKS (Azure Kubernetes Service) Variables
...
variable "app_insights_availability_test_url" {
  ...
  type        = string
  default     = "https://devopswalebaba.store"
}


# Bastion Variables (Additional Settings)
